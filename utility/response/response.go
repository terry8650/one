...
func JsonOri(ctx context.Context, content interface{}) {
...
func Success(ctx context.Context, message string, data ...interface{}) {
	var r = g.RequestFromCtx(ctx)
	JsonExit(r, 0, message, data...)

}
func Fail(ctx context.Context, code int, message string, data ...interface{}) {
	var r = g.RequestFromCtx(ctx)
	JsonExit(r, code, message, data...)
