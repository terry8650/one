...
func (c *sysMonitorController) List(ctx context.Context, req *sys.MonitorSearchReq) (res *sys.MonitorSearchRes, err error) {
	...
	res = new(sys.MonitorSearchRes)
	res = &sys.MonitorSearchRes{
		"cpuNum":          cpuNum,
		"cpuUsed":         cpuUsed,
